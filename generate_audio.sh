...
say_en "Starting development. Please agitate." "start_develop"
say_en "Please agitate." "agitate"
say_en "Please rest." "rest"
say_en "One minute left. Prepare stop bath." "one_minute"
say_en "Last agitation. Prepare stop bath." "last_agitate"
say_en "Please drain." "drain"
say_en "Pour in stop bath." "stop_bath"
say_en "Discard and prepare fixer." "discard_fix"
say_en "Process complete." "complete"
say_en "Agitate in 5 seconds." "pre_agitate"
say_en "Starting fixer." "fix_start"
say_en "Starting wash." "wash_start"
say_en "Starting wetting agent." "wetting_start"
say_en "Starting pre-soak. Please agitate." "presoak_start"
say_en "10 seconds left. Prepare stop bath." "final_ten"
